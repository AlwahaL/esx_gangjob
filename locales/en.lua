Locales['en'] = {
  ...
  ['gang_wear'] = 'Mafya Kıyafet',
  ['open_cloackroom'] = 'Kıyafetinizi değiştirmek için ~INPUT_CONTEXT~ tuşuna bas!',
  -- Armory
  ['get_weapon'] = 'Silah Al',
  ['put_weapon'] = 'Silah Bırak',
  ['buy_weapons'] = 'Silah satın almak için cartele müracaat etmelisin.',
  ['armory'] = 'Cephanelik',
  ['open_armory'] = 'Cephaneliğe erişmek için ~INPUT_CONTEXT~ tuşuna bas.',
  ['mafia_stock'] = 'Cephanelik',
  -- Vehicles
  ['vehicle_menu'] = 'Çete Garajı',
  ['vehicle_out'] = 'bu araç zaten dışarıda dostum',
  ['vehicle_spawner'] = 'Araç çıkartmak için ~INPUT_CONTEXT~ tuşuna basın.',
  ['store_vehicle'] = 'Aracı garaja koymak için ~INPUT_CONTEXT~ tuşuna bas.',
  ...
  ['search'] = 'Arama',
  ['handcuff'] = 'Kelepçe / Kelepçe çıkar',
  ['drag'] = 'Taşı',
  ['put_in_vehicle'] = 'Araca koy',
  ['out_the_vehicle'] = 'Araçtan dışarı çıkar',
  ['fine'] = 'Haraç',
